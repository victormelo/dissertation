...
% Pacotes básicos
% ---
\usepackage{lmodern}			    % Usa a fonte Times New Roman
...
\include{conteudo/introduction}
\include{conteudo/signature_verification}
\include{conteudo/generative_models}
\include{conteudo/method}
\include{conteudo/results}
\include{conteudo/conclusion}
% ----------------------------------------------------------
